...
<body>
        ...
        <main>
            ...
            <div class="right">
                ...
                <div class="list_sp">
                    <?php 
                        require_once "../site/chi_tiet.php";
                    ?>
                </div>
                ...
                <div>
                    <?php
                        ...
                        echo ' 
                        <form method="post" action="" style="display: flex;margin: 20px 0 0 20px;">
                            <textarea name="binh_luan" id="" cols="60" rows="3" ></textarea>
                            <button type="submit" name="gui" style="padding: 10px;margin-left: 20px;">gửi</button>
                        </form> ';
                        }else {
